...
public class ConsumeQueueExt {
     ...
     * <p>
     * if {@code address} is less than 0, return {@code address} - {@link Long#MIN_VALUE};
     ...
     * <p>
     * if {@code offset} is greater than or equal to 0, then return {@code offset} + {@link Long#MIN_VALUE};
