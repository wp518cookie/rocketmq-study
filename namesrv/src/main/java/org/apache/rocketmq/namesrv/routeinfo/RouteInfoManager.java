...
import org.apache.rocketmq.common.syncflag.TopicSysFlag;
...
public class RouteInfoManager {
    ...
    /**
     * 存储了所有topic的属性信息
     * list.size(): master broker
     * QueueData 相当于描述了多个MessageQueue
     */
    ...
    private int wipeWritePermOfBroker(final String brokerName) {
        ...
        while (itTopic.hasNext()) {
            Map.Entry<String, List<QueueData>> entry = itTopic.next();
            ...
            try {
                ...
                for (String brokerName : brokerNameSet) {
                    ...
                    while (topicTableIt.hasNext()) {
                        Map.Entry<String, List<QueueData>> topicEntry = topicTableIt.next();
...
class BrokerLiveInfo {
    ...
    private String haServerAddr;    //心跳地址
